export PJDIR := /cygdrive/c/Users/bstriker/Documents/Git/PJSip-CSharp
...
export CC_NAME := gcc
export TARGET_NAME := i686-pc-cygwin
export CROSS_COMPILE := 
export LINUX_POLL := select 
export SHLIB_SUFFIX := dll
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
	...
	$(APP_THIRD_PARTY_EXT)\
	$(PJLIB_LDLIB) \
	-lm -lwinmm -lole32 -lws2_32 -lwsock32 -lpthread   
